...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "JS Mobile Car Shampoo & Detailing — Allentown, PA" },
      { name: "description", content: "Premium mobile detailing in Allentown, PA. Cars, trucks, semis, sofas & homes. We come to you. Call (484) 764-3361." },
      { name: "author", content: "JS Mobile Car Shampoo & Detailing LLC" },
      { property: "og:title", content: "JS Mobile Car Shampoo & Detailing — Allentown, PA" },
      { property: "og:description", content: "Premium mobile detailing in Allentown, PA. Cars, trucks, semis, sofas & homes. We come to you. Call (484) 764-3361." },
